...
public class BluetoothControlService {
    ...
    /**
     * Constructor. Prepares a new BluetoothControl session
     *
    ...
    /**
     * Set the current state of the control connection
     *
    ...
    public synchronized void start() {
        // Chancel and thread attempting to make a connection
        if (mConnectThread != null) {
            mConnectThread.cancel();
            mConnectThread = null;
        }

        // Chancel any thread currently running a connection
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            setName("Accepted Thread" + mSocketType);
                    ...
                    synchronized (BluetoothControlService.this) {
                        switch (mState) {
                            ...
                            case STATE_CONNECTED:
                                // Either not really or already connected. Terminate new socket.
                                try {
                                    socket.close();
                                } catch (IOException e) { }
                                break;
